...
const (
	...
	ActionPresetAll       Action = "apply_filter_preset_all"
	ActionPresetSafe      Action = "apply_filter_preset_safe"
	ActionPresetDestruct  Action = "apply_filter_preset_destructive"
